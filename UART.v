module UART (
    ...
    output reg [7:0] lidar_x,
    output reg [7:0] lidar_y,
        ...
        if (rst) begin
            ...
            if (rx_dv) begin
                case (s)
                    ...
                    BYTE2: lidar_x      <= rx_byte;
                    BYTE3: lidar_y      <= rx_byte;
                    BYTE4: packet_valid <= 1'b1; // Full packet received
                endcase
            end
        end
    end
