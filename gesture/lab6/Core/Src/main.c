...
#define TAP_P2P_THRESHOLD 0.10f

#define DRAG_VARIANCE_THRESHOLD 0.002f



#define STATE_IDLE 0x01

#define STATE_TAP 0x02

#define STATE_DRAG 0x03
...
uint8_t lidar_x_upper = 0x10;

uint8_t lidar_x_lower = 0x10;

uint8_t lidar_y_upper = 0x10;

uint8_t lidar_y_lower = 0x10;

static uint8_t prev_lidar_x_upper = 0;
static uint8_t prev_lidar_x_lower = 0;
static uint8_t prev_lidar_y_upper = 0;
static uint8_t prev_lidar_y_lower = 0;

static int ignore_once = 0;
	  ...
	  //printf("ADC: %d\n\r", ADC_VAL);
...

	    {
	        ...
	        if (count >= 2) {
	    	    ...
	    	    count = 0;
	    	    //printf("TAP detected! P2P=%.4f, Var=%.6f\n\r", peak_to_peak, variance);
...
//	    send_motion_packet(motion_state, 100, 123);



//	    HAL_Delay(2); // ~500 Hz update
